...
";
            ...
            // line 7
            echo "  ";
            $this->loadTemplate("@images/RB19-logo.svg", "partials/logo.html.twig", 7)->display($context);
        }
        // line 9
        echo "</a>
";
...
{% else %}
  {% include('@images/RB19-logo.svg') %}
{% endif %}
</a>
", "partials/logo.html.twig", "/Users/cchang5/Sites/rb19/user/themes/quark/templates/partials/logo.html.twig");
    }
}
